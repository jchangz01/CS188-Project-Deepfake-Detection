...
#current datasets implemented: Celeb-DF, DFDC

#currently directly copied from 
#https://github.com/CatoGit/Comparing-the-Performance-of-Deepfake-Detection-Methods-on-Benchmark-Datasets/blob/master/deepfake_detector/datasets.py
